...
const radioChannels = {
  'raadio2': {
    name: 'Raadio 2',
    url: 'https://icecast.err.ee/raadio2madal.mp3',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/R2_logo.svg',
    color: '#FF0000'
  },
  'viker': {
    name: 'Vikerraadio',
    url: 'https://icecast.err.ee/vikerraadiomadal.mp3',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e0/Vikerraadio_logo_%282015%29.webp',
    color: '#0066CC'
  },
  'kuku': {
    name: 'Raadio Kuku',
    url: 'https://le08.euddn._low.mp3',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/3/36/Kuku_Raadio_Logo.svg',
    color: '#FF6600'
  },
  'skyplus': {
    name: 'SkyPlus',
    url: 'https://edge03.cdn.bitflip.ee:8888/SKYPLUS?_i=c1283824',
    logo: 'https://upload.wikimedia.org/wikipedia/commons/e/e3/Logo_Sky_Plus.svg',
    color: '#F4D03F'
  },
  'elmar': {
    name: 'Raadio Elmar',
    url: 'https://le08.euddn._low.mp3',
    logo: 'https://raadioelmar.ee/images/elmar-logo.svg',
    color: '#E67E22'
  },
  'retro': {
    name: 'Retro FM',
    url: 'https://edge02.cdn.bitflip.ee:8888/RETRO',
    logo: 'https://retrofm.ee/images/retro-logo.svg',
    color: '#8E44AD'
  },
  'power': {
    name: 'Power Hit Radio',
    url: 'https://ice.leviracloud.eu/phr96-aac',
    logo: 'https://power.ee/templates/power/img/power_logo.png',
    color: '#E74C3C'
  },
  'rock': {
    name: 'Rock FM',
    url: 'https://edge03.cdn.bitflip.ee:8888/rck?_i=c1283824',
    logo: 'https://rockfm.ee/images/rockfm-logo.svg',
    color: '#2C3E50'
  },
  'starfm': {
    name: 'Star FM',
    url: 'https://ice.leviracloud.eu/star320-mp3',
    logo: 'https://starfm.ee/templates/star/img/star_logo.png',
    color: '#F1C40F'
  },
  'vomba': {
    name: 'Võmba FM',
    url: 'https://c4.radioboss.fm:18123/stream',
    logo: 'https://vombafm.ee/wp-content/uploads/2021/05/vomba_logo.png',
    color: '#000000'
  },
};
...
async function playRadioStream(interaction, channelOrKey, guildStates) {
  ...
  try {
    ...
    try {
      if (interaction.deferred || interaction.replied) {
        await interaction.followUp({ content: 'Ei saanud häälekanaliga ühendust luua.', ephemeral: true });
      } else {
  ...
  try {
    const playEmbed = new EmbedBuilder()
      .setColor(channelInfo.color || Math.floor(Math.random() * 0xFFFFFF))
      .setTitle('Häälestun Raadiole...')
      .setDescription(`**${channelInfo.name}**`)
      .setThumbnail(channelInfo.logo || null)
...
async function showRadioInterface(message) {
  ...
  const buttonRow = new ActionRowBuilder().addComponents(randomButton, stopButton, backButton);
